...
- HTF Breakout Study / 15m TC-L / 30m A-L HMR100: NA (0 judged / 1 total)
...
- BTCUSDT + Context Shift: NA (0 judged / 1 total)
- BTCUSDT + L-ZONE / C-L / TC-L: NA (0 judged / 1 total)
...
- BTCUSDT.P + HTF Breakout Study / 15m TC-L / 30m A-L HMR100: NA (0 judged / 1 total)
...
## EXH 后转化为 LONG/SHORT 的案例数量

- 当前可粗略识别案例数量: 0
- 说明: 当前字段没有单独的 `exh_conversion`，这里只通过 `signal_chain` 是否同时包含 EXH 与 LONG/SHORT 粗略统计。后续如需严格统计，可以新增独立字段。
